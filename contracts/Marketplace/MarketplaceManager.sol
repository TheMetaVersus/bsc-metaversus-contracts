    ...
    IMarketplaceManager
{
     ...
     */
    function setPermitedNFT(address _nftAddress, bool _allow) external onlyAdmin {
     ...
     */
    function setPermitedPaymentToken(IERC20Upgradeable _paymentToken, bool _allow) external onlyAdmin {
        if (_allow) {
